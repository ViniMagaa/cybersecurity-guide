...
const Beam = ({
  ...
  const brightness = Math.floor(Math.random() * 60) + 40; // entre 40% e 100% de "brilho"
      ...
      style={
        {
          ...
          "--width": `${width}`,
          "--aspect-ratio": `${ar}`,
          "--background": `linear-gradient(hsl(0 0% ${brightness}%), transparent)`,
        } as React.CSSProperties
      }
      className={
        "absolute top-0 left-[var(--x)] [aspect-ratio:1/var(--aspect-ratio)] [width:var(--width)] [background:var(--background)]"
      }
